...
class TrendingListRepository extends BaseRepository
{
    ...
    {
        return 'Models\TrendingList';
    }

    public function getTrending($countryId , $userId = null , $maxCount = null)
    {
        $this->model = $this->model
            ...
            ->join('masters', 'trending_list.master_id', 'masters.id')
